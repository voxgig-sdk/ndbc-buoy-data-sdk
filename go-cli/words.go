...
func registerSDKWords(r *eng.Registry, client *sdk.NdbcBuoyDataSDK) {
...
func runOp(client *sdk.NdbcBuoyDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
