// Command NdbcBuoyData-cli is a CLI + REPL for the NdbcBuoyData SDK,
...
const prompt = "ndbc-buoy-data"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "buoy"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      NDBC_BUOY_DATA_APIKEY (api key), NDBC_BUOY_DATA_BASE (base url override)")
