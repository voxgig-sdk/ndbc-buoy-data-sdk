...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ndbc-buoy-data` | `npm install @voxgig-sdk/ndbc-buoy-data` |
| Python | `voxgig-sdk-ndbc-buoy-data` | `pip install voxgig-sdk-ndbc-buoy-data` |
| PHP | `voxgig-sdk/ndbc-buoy-data` | `composer require voxgig-sdk/ndbc-buoy-data` |
| Golang | `github.com/voxgig-sdk/ndbc-buoy-data-sdk/go` | `go get github.com/voxgig-sdk/ndbc-buoy-data-sdk/go` |
| Ruby | `voxgig-sdk-ndbc-buoy-data` | `gem install voxgig-sdk-ndbc-buoy-data` |
| Lua | `voxgig-sdk-ndbc-buoy-data` | `luarocks install voxgig-sdk-ndbc-buoy-data` |
