...
raise a `NdbcBuoyDataError` (a `StandardError` subclass), so wrap
...
```
rb/
├── NdbcBuoyData_sdk.rb       -- Main SDK module
...
The main module (`NdbcBuoyData_sdk`) exports the SDK class
