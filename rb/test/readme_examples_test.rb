...
#      offline in seeded test mode (NdbcBuoyDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "NdbcBuoyData_sdk.rb")
  SDK_CLASS = "NdbcBuoyDataSDK"
