# NdbcBuoyData Ruby SDK Reference

Complete API reference for the NdbcBuoyData Ruby SDK.
...
#### `NdbcBuoyDataSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Buoy.list(nil)
```
