...
(0, node_test_1.describe)('BuoyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NdbcBuoyDataSDK({
    ...
    (0, node_test_1.test)('direct-load-buoy', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-buoy', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-buoy', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-buoy', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NdbcBuoyDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['NDBC_BUOY_DATA_TEST_BUOY_ENTID'];
    ...
    const client = new __1.NdbcBuoyDataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=BuoyDirect.test.js.map