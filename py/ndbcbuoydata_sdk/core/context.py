...
from ndbcbuoydata_sdk.core.control import NdbcBuoyDataControl
...
from ndbcbuoydata_sdk.core.helpers import get_ctx_prop, to_map
...
class NdbcBuoyDataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, NdbcBuoyDataSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NdbcBuoyDataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NdbcBuoyDataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NdbcBuoyDataError(code, msg, self)
