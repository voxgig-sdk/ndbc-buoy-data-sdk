...
from ndbcbuoydata_sdk.utility import register

# Load features
from ndbcbuoydata_sdk.feature.base_feature import NdbcBuoyDataBaseFeature
from ndbcbuoydata_sdk.features import _has_feature, _make_feature
...
class NdbcBuoyDataSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = NdbcBuoyDataUtility()
        self._utility = utility

        from ndbcbuoydata_sdk.config import shared_config
    ...
    def get_utility(self):
        return NdbcBuoyDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NdbcBuoyDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Buoy(self, data=None) -> "BuoyEntity":
        ...
        from ndbcbuoydata_sdk.entity.buoy_entity import BuoyEntity
