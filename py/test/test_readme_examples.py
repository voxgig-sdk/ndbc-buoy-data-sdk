# NdbcBuoyData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NdbcBuoyDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NdbcBuoyDataSDK(...) and NdbcBuoyDataSDK.test(...) become
#      NdbcBuoyDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ndbcbuoydata_sdk"
_SDK_CLASS = "NdbcBuoyDataSDK"
