...
class NdbcBuoyDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NdbcBuoyDataTestRunner.getenv("NDBCBUOYDATA_TEST_LIVE")
        override = NdbcBuoyDataTestRunner.getenv("NDBCBUOYDATA_TEST_OVERRIDE")
        ...
        explain = NdbcBuoyDataTestRunner.getenv("NDBCBUOYDATA_TEST_EXPLAIN")
