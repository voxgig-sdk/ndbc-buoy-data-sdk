...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Buoy()` — each
...
| `name` | `str` | Name of the buoy station |
| `station_id` | `str` | Unique identifier for the buoy station |
...
```
py/
├── ndbcbuoydata_sdk.py         -- Main SDK module
