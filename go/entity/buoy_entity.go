...
type BuoyEntity struct {
	name    string
	client  *core.NdbcBuoyDataSDK
...
func NewBuoyEntity(client *core.NdbcBuoyDataSDK, entopts map[string]any) *BuoyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BuoyEntity) GetName() string { return e.name }
...
func (e *BuoyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BuoyEntity) Deleted() bool {
	return e.deleted
}


func (e *BuoyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBuoyEntity(e.client, opts)
}

func (e *BuoyEntity) Data(args ...any) any {
...
func (e *BuoyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Buoy; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BuoyEntity) DataTyped(data ...Buoy) Buoy {
	if len(data) > 0 {
		return typedFrom[Buoy](e.Data(asMap(data[0])))
	}
	return typedFrom[Buoy](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Buoy (all fields
// optional at the wire level).
func (e *BuoyEntity) MatchTyped(match ...Buoy) Buoy {
	if len(match) > 0 {
		return typedFrom[Buoy](e.Match(asMap(match[0])))
	}
	return typedFrom[Buoy](e.Match())
}
...
func (e *BuoyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BuoyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BuoyLoadMatch and returns an Buoy. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BuoyEntity) LoadTyped(reqmatch BuoyLoadMatch, ctrl map[string]any) (Buoy, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Buoy{}, err
	}
	return typedFrom[Buoy](res), nil
}




func (e *BuoyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// BuoyListMatch and returns []Buoy. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BuoyEntity) ListTyped(reqmatch BuoyListMatch, ctrl map[string]any) ([]Buoy, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Buoy](res), nil
}



func (e *BuoyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BuoyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BuoyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BuoyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
