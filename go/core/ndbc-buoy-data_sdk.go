...
func (sdk *NdbcBuoyDataSDK) OptionsMap() map[string]any {
...
func (sdk *NdbcBuoyDataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *NdbcBuoyDataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *NdbcBuoyDataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NdbcBuoyDataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *NdbcBuoyDataSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *NdbcBuoyDataSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("NdbcBuoyDataSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *NdbcBuoyDataSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NdbcBuoyDataSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("NdbcBuoyDataSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *NdbcBuoyDataSDK {
	...
	sdk := NewNdbcBuoyDataSDK(sdkopts)
	sdk.Mode = "test"
