...
|---|---|---|
| `ts/` | @voxgig-sdk/ndbc-buoy-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ndbc-buoy-data-sdk \
      --repository voxgig-sdk/ndbc-buoy-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ndbc-buoy-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ndbc-buoy-data-sdk --id=<id>` removes it.
