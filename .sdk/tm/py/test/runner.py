...
class NdbcBuoyDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NdbcBuoyDataTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = NdbcBuoyDataTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = NdbcBuoyDataTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
