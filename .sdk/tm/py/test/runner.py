...
class NdbcBuoyDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NdbcBuoyDataTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = NdbcBuoyDataTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = NdbcBuoyDataTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
