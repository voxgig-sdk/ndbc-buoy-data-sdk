...
// NdbcBuoyData SDK netsim feature
...
class NdbcBuoyDataNetsimFeature extends NdbcBuoyDataBaseFeature
{
    ...
    private function _simulate(NdbcBuoyDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NdbcBuoyDataContext $ctx, array $applied): void
    {
        $client = $this->client;
