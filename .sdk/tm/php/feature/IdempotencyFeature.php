...
// NdbcBuoyData SDK idempotency feature
...
class NdbcBuoyDataIdempotencyFeature extends NdbcBuoyDataBaseFeature
{
    ...
    private function _mutating(NdbcBuoyDataContext $ctx): bool
    {
