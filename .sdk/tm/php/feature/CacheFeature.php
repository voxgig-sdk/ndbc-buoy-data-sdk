...
// NdbcBuoyData SDK cache feature
...
class NdbcBuoyDataCacheFeature extends NdbcBuoyDataBaseFeature
{
    ...
    private function _through(NdbcBuoyDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
