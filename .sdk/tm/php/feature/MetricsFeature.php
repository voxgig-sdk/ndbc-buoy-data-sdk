...
// NdbcBuoyData SDK metrics feature
...
class NdbcBuoyDataMetricsFeature extends NdbcBuoyDataBaseFeature
{
    ...
    private function _record(NdbcBuoyDataContext $ctx, bool $ok): void
    {
