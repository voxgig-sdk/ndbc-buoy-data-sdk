...
// NdbcBuoyData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NdbcBuoyDataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NdbcBuoyDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(NdbcBuoyDataOmni::structfix($val, Struct::undef()))) {
