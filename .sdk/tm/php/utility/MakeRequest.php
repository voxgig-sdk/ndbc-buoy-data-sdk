...
// NdbcBuoyData SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NdbcBuoyDataMakeRequest
{
    public static function call(NdbcBuoyDataContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NdbcBuoyDataResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NdbcBuoyDataResponse($fetched);
        } else {
