...
// NdbcBuoyData SDK utility: fetcher

class NdbcBuoyDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NdbcBuoyDataSDK/1.0)';
    ...
    public static function call(NdbcBuoyDataContext $ctx, string $fullurl, array $fetchdef): array
    {
