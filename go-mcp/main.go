// Command NdbcBuoyData-mcp is an MCP server exposing the NdbcBuoyData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NdbcBuoyData_list  — list records of an entity
//	NdbcBuoyData_load  — load a single record of an entity
//
