...
type Args struct {
	Entity string         `json:"entity" jsonschema:"buoy"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NdbcBuoyDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ndbc-buoy-data_list",
		Description: "List records from NdbcBuoyData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ndbc-buoy-data_load",
		Description: "Load a single record from NdbcBuoyData. " +
...
func runOp(client *sdk.NdbcBuoyDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NdbcBuoyDataSDK, name string) (sdk.NdbcBuoyDataEntity, error) {
	switch strings.ToLower(name) {
	case "buoy":
		return client.Buoy(nil), nil
