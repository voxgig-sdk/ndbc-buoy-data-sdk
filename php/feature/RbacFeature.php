...
class NdbcBuoyDataRbacFeature extends NdbcBuoyDataBaseFeature
{
    ...
    private function _required(NdbcBuoyDataContext $ctx): ?string
    {
    ...
    private function _reject(NdbcBuoyDataContext $ctx, string $required): void
    {
    ...
    private function _track(NdbcBuoyDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
