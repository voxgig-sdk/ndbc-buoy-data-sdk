...
// NdbcBuoyData SDK clienttrack feature
...
class NdbcBuoyDataClienttrackFeature extends NdbcBuoyDataBaseFeature
{
    ...
    public function PostConstruct(NdbcBuoyDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NdbcBuoyData-SDK';
