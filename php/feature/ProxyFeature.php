...
// NdbcBuoyData SDK proxy feature
...
class NdbcBuoyDataProxyFeature extends NdbcBuoyDataBaseFeature
{
    ...
    public function init(NdbcBuoyDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NdbcBuoyDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
