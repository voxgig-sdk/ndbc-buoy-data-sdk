...
// NdbcBuoyData SDK streaming feature
...
class NdbcBuoyDataStreamingFeature extends NdbcBuoyDataBaseFeature
{
    ...
    private function _iterate(NdbcBuoyDataResult $result): \Generator
    {
    ...
    private function _streamable(NdbcBuoyDataContext $ctx): bool
    {
