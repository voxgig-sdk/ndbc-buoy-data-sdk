...
// NdbcBuoyData SDK audit feature
...
class NdbcBuoyDataAuditFeature extends NdbcBuoyDataBaseFeature
{
    ...
    private function _emit(NdbcBuoyDataContext $ctx, string $outcome): void
    {
