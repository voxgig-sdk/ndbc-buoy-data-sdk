...
// NdbcBuoyData SDK timeout feature
...
class NdbcBuoyDataTimeoutFeature extends NdbcBuoyDataBaseFeature
{
    ...
    private function _with_timeout(NdbcBuoyDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NdbcBuoyDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
