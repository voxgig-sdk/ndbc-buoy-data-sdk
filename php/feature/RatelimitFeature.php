...
// NdbcBuoyData SDK ratelimit feature
...
class NdbcBuoyDataRatelimitFeature extends NdbcBuoyDataBaseFeature
{
    ...
    private function _acquire(NdbcBuoyDataContext $ctx): void
    {
    ...
    private function _track(NdbcBuoyDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
