...
// NdbcBuoyData SDK utility: graphql
//
...
class NdbcBuoyDataGraphql
{
    ...
    // equivalent.
    public static function body(NdbcBuoyDataContext $ctx): mixed
    {
    ...
    public static function errors(NdbcBuoyDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
