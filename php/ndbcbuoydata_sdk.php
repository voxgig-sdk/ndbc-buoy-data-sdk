...
class NdbcBuoyDataSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = NdbcBuoyDataHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = NdbcBuoyDataHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!NdbcBuoyDataFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, NdbcBuoyDataFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return NdbcBuoyDataUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = NdbcBuoyDataHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = NdbcBuoyDataHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = NdbcBuoyDataHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new NdbcBuoyDataError($op . "_allow",
                "NdbcBuoyDataSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = NdbcBuoyDataHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new NdbcBuoyDataError("graphql_error",
                "NdbcBuoyDataSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Buoy($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_buoy === null) {
                $this->_buoy = new BuoyEntity($this, null);
            }
            return $this->_buoy;
        }
        return new BuoyEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new NdbcBuoyDataSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
