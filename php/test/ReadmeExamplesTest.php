...
// NdbcBuoyData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NdbcBuoyDataSDK::test)
...
{
    private const SDK_CLASS = 'NdbcBuoyDataSDK';
    ...
    private const SDK_BASE = 'ndbcbuoydata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ndbcbuoydata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
