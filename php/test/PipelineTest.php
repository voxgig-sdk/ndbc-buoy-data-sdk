...
// NdbcBuoyData SDK pipeline test
//
...
{
    private static function utility(): NdbcBuoyDataUtility
    {
        return new NdbcBuoyDataUtility();
    }
    ...
    private static function ctx(array $over = []): NdbcBuoyDataContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NdbcBuoyDataContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NdbcBuoyDataOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NdbcBuoyDataError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NdbcBuoyDataOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NdbcBuoyDataMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NdbcBuoyDataOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NdbcBuoyDataMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NdbcBuoyDataOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NdbcBuoyDataMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NdbcBuoyDataSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NdbcBuoyDataMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NdbcBuoyDataResponse([]),
            'result' => new NdbcBuoyDataResult([]),
        ]);
        [, $err] = NdbcBuoyDataMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NdbcBuoyDataSpec([]),
            'response' => null,
            'result' => new NdbcBuoyDataResult([]),
        ]);
        [, $err] = NdbcBuoyDataMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NdbcBuoyDataSpec(['step' => 's']),
            'response' => new NdbcBuoyDataResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NdbcBuoyDataResult([]),
        ]);
        [, $err] = NdbcBuoyDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NdbcBuoyDataSpec(['step' => 's']),
            'response' => new NdbcBuoyDataResponse(self::resp(200, ['v' => 1])),
            'result' => new NdbcBuoyDataResult([]),
        ]);
        [, $err] = NdbcBuoyDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NdbcBuoyDataSpec(['step' => 's']),
            'response' => new NdbcBuoyDataResponse(self::resp(200, ['v' => 2])),
            'result' => new NdbcBuoyDataResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NdbcBuoyDataMakeResponse::call($ctx);
    ...
    {
        $preset = new NdbcBuoyDataResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NdbcBuoyDataSpec([]),
            'response' => new NdbcBuoyDataResponse([]),
            'result' => new NdbcBuoyDataResult([]),
        ...
        [$got, $err] = NdbcBuoyDataMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NdbcBuoyDataResult([])]);
        [, $err] = NdbcBuoyDataMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NdbcBuoyDataSpec([]), 'result' => null]);
        [, $err] = NdbcBuoyDataMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NdbcBuoyDataSpec(['step' => 's']),
            'result' => new NdbcBuoyDataResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NdbcBuoyDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NdbcBuoyDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NdbcBuoyDataSpec(['step' => 's']),
            'result' => new NdbcBuoyDataResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NdbcBuoyDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NdbcBuoyDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NdbcBuoyDataResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NdbcBuoyDataSpec([]),
            'result' => new NdbcBuoyDataResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NdbcBuoyDataMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NdbcBuoyDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NdbcBuoyDataError('boom', 'boom');
        $utility->fetcher = function (NdbcBuoyDataContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NdbcBuoyDataSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NdbcBuoyDataMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NdbcBuoyDataContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NdbcBuoyDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NdbcBuoyDataResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        NdbcBuoyDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NdbcBuoyDataContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NdbcBuoyDataSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NdbcBuoyDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NdbcBuoyDataResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NdbcBuoyDataSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NdbcBuoyDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NdbcBuoyDataMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NdbcBuoyDataMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NdbcBuoyDataResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NdbcBuoyDataDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NdbcBuoyDataResult(['ok' => false])]);
        $this->expectException(NdbcBuoyDataError::class);
        NdbcBuoyDataDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NdbcBuoyDataResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NdbcBuoyDataMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NdbcBuoyDataMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NdbcBuoyDataBaseFeature();
        $b = new NdbcBuoyDataBaseFeature();
        NdbcBuoyDataFeatureAdd::call($ctx, $a);
        NdbcBuoyDataFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NdbcBuoyDataBaseFeature
    {
        $f = new NdbcBuoyDataBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NdbcBuoyDataFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NdbcBuoyDataContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NdbcBuoyDataSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NdbcBuoyDataPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        NdbcBuoyDataPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NdbcBuoyDataResponse(['headers' => null]),
            'result' => new NdbcBuoyDataResult([]),
        ]);
        NdbcBuoyDataResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        NdbcBuoyDataResultBody::call($ctx);
