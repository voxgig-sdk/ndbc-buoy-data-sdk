...
// NdbcBuoyData SDK utility type

class NdbcBuoyDataUtility
{
    ...
    public static function copy(NdbcBuoyDataUtility $src): NdbcBuoyDataUtility
    {
        $u = new NdbcBuoyDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
